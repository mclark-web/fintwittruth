  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10">
      ...
      <div className="mt-6 space-y-4 text-ink/80">
        ...
        <p>
          The accounts, posts, and prices shipped with this app are a fictional demo. They are labeled as demo
          data. They are not quotes from real people and they are not official market data.
        </p>
        <p>
          FinTwitTruth is not affiliated with, endorsed by, or a product of X, Twitter, or any exchange, broker,
          or data vendor. &quot;FinTwit&quot; describes a public style of market commentary. It is not a claim of
          partnership.
        </p>
        <p>
          ...
          treat every number as an illustration of the calendar and the score.
        </p>
      </div>
    </div>
  );
