  ...
  return (
    <div className="mx-auto max-w-xl px-4 py-10">
      ...
      <p className="mt-3 text-sm text-muted">
        Monday is the open of the 12:00 PM ET 5-minute bar. Wednesday and Friday real calls use the 4:00 PM ET
        close. Say which print or post looks wrong. A dispute does not change the score by itself.
      </p>
