...
**GC Scale.** The horizontal tube fill is the 0–100 score. **STRONG** is 70 or more. **WEAK** is under 40. **PROVISIONAL** is 40 up to 70. **EXIT LIQUIDITY** is a 0% fill: an empty glass when no graded horizon has closed, or when the score is 0.
